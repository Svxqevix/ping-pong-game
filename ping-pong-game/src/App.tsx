...
const App: React.FC = () => {
    const initialBallState: BallState = { x: 300, y: 200, speedX: 5, speedY: 5 };
    const initialPaddleState: PaddleState = { left: 150, right: 150 };

    const [ball, setBall] = useState<BallState>(initialBallState);
    const [paddles, setPaddles] = useState<PaddleState>(initialPaddleState);
